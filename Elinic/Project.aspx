...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
   ...
   <script type="text/javascript">
       ...
       $("[id ^= 'Redo']").click(function () {
           ...
           $parent.find(".customized-values > .customized-values").html("If you would like this component in your project, add it by clicking the <div class='d-inline-block'><i class='fa fa-cog mr-2'></i>Configure</div>" +
               " button.");
           id = this.id.replace(/[^\d.]/g, '');
           $.ajax({
               type: "POST",
